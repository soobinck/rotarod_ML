...
inputCSV = os.path.join(outputAbsPath(), 'featureImportance', 'featureImportance_decisionTree.csv')
...
outputPath = os.path.join(outputAbsPath(), 'featureImportance', 'featureImportance10intervals.png')
